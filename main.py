...
class ReseauAssainissementPlugin(QObject):
    ...
    def run_conduite_eu(self, checked):
        if not checked:
            ...
            return
        couches = self._get_couches("EU")
        if not couches:
            return
        from .tools.draw_conduite_tool import DrawConduiteTool
        tool = DrawConduiteTool(self.iface.mapCanvas(), reseau="EU", couches=couches)
        self._activate_tool("conduite_eu", tool)

    def run_conduite_ep(self, checked):
        if not checked:
            self._deactivate_current()
            return
        couches = self._get_couches("EP")
        if not couches:
            return
        from .tools.draw_conduite_tool import DrawConduiteTool
        tool = DrawConduiteTool(self.iface.mapCanvas(), reseau="EP", couches=couches)
        self._activate_tool("conduite_ep", tool)
    ...
    def run_branchement_eu(self, checked):
        ...
        tool = DrawBranchementTool(self.iface.mapCanvas(), reseau="EU", couches=couches)
        self._activate_tool("branchement_eu", tool)
    ...
    def run_branchement_ep(self, checked):
        ...
        if not couches:
            return
        from .tools.draw_branchement_tool import DrawBranchementTool
        tool = DrawBranchementTool(self.iface.mapCanvas(), reseau="EP", couches=couches)
        self._activate_tool("branchement_ep", tool)
    ...
    def run_renseignement(self, checked):
        ...
        tool = RenseignementTool(self.iface.mapCanvas(),
                                 couches_eu=couches_eu, couches_ep=couches_ep)
        self._activate_tool("renseignement", tool)
    ...
    def run_insert_regard(self, checked):
        ...
        tool = InsertRegardTool(self.iface.mapCanvas(), couches_eu=couches_eu, couches_ep=couches_ep)
        self._activate_tool("insert_regard", tool)
    ...
    def run_delete(self, checked):
        ...
        tool = DeleteTool(self.iface.mapCanvas(), couches_eu=couches_eu, couches_ep=couches_ep)
        self._activate_tool("delete", tool)
    ...
    def run_move(self, checked):
        ...
        tool = MoveTool(self.iface.mapCanvas(),
                        couches_eu=couches_eu, couches_ep=couches_ep)
        self._activate_tool("move", tool)
    ...
    def run_copy_attributes(self, checked):
        ...
        tool = CopyAttributesTool(self.iface.mapCanvas(),
                                  couches_eu=couches_eu, couches_ep=couches_ep)
        self._activate_tool("copy_attributes", tool)
    ...
    def run_profil_eu(self, checked):
        ...
        tool = ProfilTool(self.iface.mapCanvas(), self.iface, "EU", couches)
        self._activate_tool("profil_eu", tool)
    ...
    def run_profil_ep(self, checked):
        ...
        if not couches:
            return
        from .tools.profil_tool import ProfilTool
        tool = ProfilTool(self.iface.mapCanvas(), self.iface, "EP", couches)
        self._activate_tool("profil_ep", tool)
    ...
    def run_renommer_eu(self, checked):
        ...
        tool = RenommerTool(self.iface.mapCanvas(), self.iface, "EU", couches)
        self._activate_tool("renommer_eu", tool)
    ...
    def run_renommer_ep(self, checked):
        ...
        if not couches:
            return
        from .tools.renommer_tool import RenommerTool
        tool = RenommerTool(self.iface.mapCanvas(), self.iface, "EP", couches)
        self._activate_tool("renommer_ep", tool)
    ...
    def run_profil_groupe(self, checked):
        ...
        tool = ProfilGroupeTool(self.iface.mapCanvas(), self.iface,
                                couches_eu, couches_ep)
        self._activate_tool("profil_groupe", tool)
