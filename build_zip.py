...
fichiers de travail (audit.md, amelioration.txt, uml_structure.puml, .gitignore,
build_zip.py lui-même) et fichiers temporaires (*.pyc, *.tmp).
...
EXCLUDE_FILES = {
    "audit.md", "amelioration.txt", "uml_structure.puml",
